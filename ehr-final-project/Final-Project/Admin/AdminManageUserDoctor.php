...
<?php
  try{
      ...
      $sql = "SELECT doctor.doc_id, doctor.staff_id, doctor.name, doctor.contact, user.username 
                FROM doctor 
...
?>
        <div class="main p-3">
            ...
            <div class="Accountcounts">
                <div class="Repacc">
                    <a href="AdminAddDoctor.php" class="btn btn-secondary btn-lg active" role="button" aria-pressed="true">+Add User</a>
                </div>
            ...
            <?php
                if (isset($_GET['delete']) && is_numeric($_GET['delete'])) {
                    ...
                    $deleteSql = "DELETE FROM doctor WHERE doc_id = :doc_id";
